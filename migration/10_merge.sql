...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('Seguimiento registrado para ' || p_dim);
END;
/
...
BEGIN
  DBMS_OUTPUT.PUT_LINE('Iniciando PRC_DIM_HORA con parámetro: ' || p_param);
  IF p_param = 1 THEN
    MERGE INTO BD2_DIM_HORA D
    USING (SELECT DISTINCT TRIM(HORA) AS HORA FROM stage.BD2_STG_DATOS) S
    ON (D.HORA = S.HORA)
    WHEN NOT MATCHED THEN
      INSERT (HORA) VALUES (S.HORA);

  ELSIF p_param = 2 THEN
    MERGE INTO BD2_DIM_HORA D
    USING (SELECT DISTINCT TRIM(HORA_COD) AS HORA FROM BD2_NO_HECHOS) S
    ON (D.HORA = S.HORA)
    WHEN NOT MATCHED THEN
      INSERT (HORA) VALUES (S.HORA);
  END IF;

  DBMS_OUTPUT.PUT_LINE('Finalizando PRC_DIM_HORA');
  PRC_LLENA_SEGUIMIENTO('BD2_DIM_HORA');

EXCEPTION
  WHEN OTHERS THEN
    DBMS_OUTPUT.PUT_LINE('Error en PRC_DIM_HORA: ' || SQLERRM);
    RAISE;
END;
/
...
BEGIN
  ...
  ELSIF p_param = 2 THEN
    ...
    WHEN NOT MATCHED THEN
      INSERT (NOMBRE_RONDA) VALUES (S.RONDA);
  END IF;
  DBMS_OUTPUT.PUT_LINE('Finalizando PRC_DIM_RONDA');
...
BEGIN
  DBMS_OUTPUT.PUT_LINE('Iniciando PRC_DIM_SELECCION con parámetro: ' || p_param);
  IF p_param = 1 THEN
    ...
    USING (
      SELECT NOMBRE_SELECCION FROM (
        ...
        UNION
        SELECT DISTINCT EQUIPO_VISITA AS NOMBRE_SELECCION FROM stage.BD2_STG_DATOS
      )
    ) S
    ON (D.NOMBRE_SELECCION = S.NOMBRE_SELECCION)
    WHEN NOT MATCHED THEN
      INSERT (NOMBRE_SELECCION) VALUES (S.NOMBRE_SELECCION);
  ELSIF p_param = 2 THEN
    MERGE INTO BD2_DIM_SELECCION D
    USING (
      SELECT NOMBRE_SELECCION FROM (
    ...
    WHEN NOT MATCHED THEN
      INSERT (NOMBRE_SELECCION) VALUES (S.NOMBRE_SELECCION);
  END IF;
  DBMS_OUTPUT.PUT_LINE('Finalizando PRC_DIM_SELECCION');
...
BEGIN
  DBMS_OUTPUT.PUT_LINE('Iniciando PRC_DIM_PAIS_ORGANIZADOR con parámetro: ' || p_param);
  IF p_param = 1 THEN
    ...
    WHEN NOT MATCHED THEN
      INSERT (NOMBRE_PAIS_ORGANIZADOR) VALUES (S.PAIS);
  ELSIF p_param = 2 THEN
    MERGE INTO BD2_DIM_PAIS_ORGANIZADOR D
    ...
    WHEN NOT MATCHED THEN
      INSERT (NOMBRE_PAIS_ORGANIZADOR) VALUES (S.PAIS);
  END IF;
  DBMS_OUTPUT.PUT_LINE('Finalizando PRC_DIM_PAIS_ORGANIZADOR');
...
BEGIN
  DBMS_OUTPUT.PUT_LINE('Iniciando PRC_DIM_CIUDAD con parámetro: ' || p_param);
  IF p_param = 1 THEN
    MERGE INTO BD2_DIM_CIUDAD D
    USING (SELECT DISTINCT CIUDAD FROM stage.BD2_STG_DATOS) S
    ON (D.CIUDAD_ORGANIZADOR = S.CIUDAD)
    WHEN NOT MATCHED THEN
      INSERT (CIUDAD_ORGANIZADOR, PAIS_KEY) VALUES (S.CIUDAD, NULL);
  ELSIF p_param = 2 THEN
    MERGE INTO BD2_DIM_CIUDAD D
    ...
    WHEN NOT MATCHED THEN
      INSERT (CIUDAD_ORGANIZADOR, PAIS_KEY) VALUES (S.CIUDAD, NULL);
  END IF;
  DBMS_OUTPUT.PUT_LINE('Finalizando PRC_DIM_CIUDAD');
...
BEGIN
  ...
  ELSIF p_param = 2 THEN
    ...
    WHEN NOT MATCHED THEN
      INSERT (NOMBRE_ESTADIO) VALUES (S.ESTADIO);
  END IF;
  DBMS_OUTPUT.PUT_LINE('Finalizando PRC_DIM_ESTADIO');
