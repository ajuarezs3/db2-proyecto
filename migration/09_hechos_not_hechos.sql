...
BEGIN
  IF p_param = 1 THEN
    FOR r IN (
      SELECT * FROM DW.BD2_STG_DATOS S
      ...
      IF r.HORA_KEY IS NOT NULL AND r.RONDA_KEY IS NOT NULL AND r.ESTADIO_KEY IS NOT NULL AND
         r.CIUDAD_KEY IS NOT NULL AND r.PAIS_KEY IS NOT NULL AND r.SELECCION_KEY IS NOT NULL AND r.VISITANTE_KEY IS NOT NULL THEN
        ...
        VALUES (
          ...
          r.ESTADIO_KEY, r.SELECCION_KEY, r.VISITANTE_KEY, r.GOL_LOCAL, r.GOL_VISITA, r.ASISTENCIA
        );
      ELSE
        INSERT INTO DW.BD2_NO_HECHOS (
          ANIO, FECHA, HORA_COD, NOMBRE_RONDA, ESTADIO, CIUDAD, PAIS,
          EQUIPO_LOCAL, GOL_LOCAL, GOL_VISITA, EQUIPO_VISITA, ASISTENCIA
        )
        VALUES (
          r.ANIO, r.FECHA, r.HORA, r.RONDA, r.ESTADIO, r.CIUDAD, r.PAIS,
          r.EQUIPO_LOCAL, r.GOL_LOCAL, r.GOL_VISITA, r.EQUIPO_VISITA, r.ASISTENCIA
        );
      END IF;
    END LOOP;
