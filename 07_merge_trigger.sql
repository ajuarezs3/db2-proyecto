-- ============================================
-- TRIGGERS EN PRODUCCIÓN PARA WATERMARK
-- ============================================
CREATE OR REPLACE TRIGGER TRG_TABLA_SINC
AFTER INSERT OR UPDATE OR SELECT ON BD2_HECHOS
FOR EACH ROW
BEGIN
  INSERT INTO WATERMARK (TABLA, PK, OPERACION, FECHA_INSERT)
  VALUES ('BD2_HECHOS', :NEW.ANIO, 
          CASE 
...
-- ============================================
-- PROCEDIMIENTO EN STAGE: PRC_SINCRONIZACION
-- ============================================
...
BEGIN
  IF p_param = 1 THEN
    ...
    USING (SELECT DISTINCT ESTADIO FROM BD2_STG_DATOS) S
...
BEGIN
  IF p_param = 1 THEN
    ...
    USING (SELECT DISTINCT CIUDAD FROM BD2_STG_DATOS) S
...
BEGIN
  IF p_param = 1 THEN
    ...
    USING (SELECT DISTINCT PAIS FROM BD2_STG_DATOS) S
...
-- ============================================
CREATE OR REPLACE PROCEDURE PRC_LLENA_SEGUIMIENTO(p_dim IN VARCHAR2) IS
BEGIN
  INSERT INTO BD2_SEGUIMIENTO VALUES (p_dim, USER, SYSDATE);
END;
/
