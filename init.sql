...
DROP TABLE BD2_DIM_HORA; 
DROP TABLE BD2_DIM_RONDA; 
DROP TABLE BD2_DIM_SELECCION; 
DROP TABLE BD2_HECHOS; 
DROP TABLE BD2_NO_HECHOS; 
DROP TABLE BD2_STG_DATOS; 
DROP TABLE BD2_DIM_ESTADIO; 
DROP TABLE BD2_DIM_CIUDAD; 
DROP TABLE BD2_DIM_PAIS_ORGANIZADOR; 
DROP TABLE BD2_CORRELATIVOS; 
DROP TABLE BD2_VALORES_DEFAULT; 
DROP TABLE BD2_SEGUIMIENTO; 
